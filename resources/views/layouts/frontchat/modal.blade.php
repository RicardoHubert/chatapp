            ...
            <div class="modal-body p-4">
                ...
                <div class="form-group">
                    <div class="form-control-wrap">
                        ...
                        <input type="text" class="form-control form-control-solid" id="search-contact" placeholder="Search contact" autocomplete="off" onkeyup="search_user('{{ Auth::id() }}', this.value);">
                    </div>
                </div>
                <div id="search_people_area" class="mt-3">
